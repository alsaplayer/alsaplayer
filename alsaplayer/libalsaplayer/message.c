...
{
	return (ap_cmd_set_int(session, AP_SET_POS_BLOCK, block));
}
...
{
	return (ap_cmd_get_int(session, AP_GET_POS_BLOCK, val));
}

int ap_get_blocks(int session, int *val)
{
	return (ap_cmd_get_int(session, AP_GET_SONG_LENGTH_BLOCK, val));
}
